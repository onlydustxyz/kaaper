...
//     const functionText = CairoParser.parseFunctionScopeWithMatchAll(text, "constructor");
//     const commentText = CairoParser.parseCommentLinesWithMatchAll(functionText![0])!.text;
//     const functionCommentText = commentText!.join("\n");
...
//     assert.equal(
//       false,
//       explicitArgsParser.isEndScope(commentText![line]),
