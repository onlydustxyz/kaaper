...
suite("dumpParsingResult", () => {
  test("ERC20: should dump all", () => {
    ...
    const generatedYAMLFile = fs.readFileSync(path.resolve(__dirname, "../../../../../../docs/ERC20.yaml"), "utf8");
    const targetYAMLFile = fs.readFileSync(path.resolve(__dirname, "../../../../../../testGeneratedDocs/ERC20.yaml"), "utf8");
